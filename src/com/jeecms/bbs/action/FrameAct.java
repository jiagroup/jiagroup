...
public class FrameAct {
	...
	@RequestMapping("/frame/topic_main.do")
	public String topicMain(ModelMap model){
		return "frame/topic_main";
	}
	
	@RequestMapping("/frame/topic_left.do")
	public String topicLeft(ModelMap model){
		return "frame/topic_left";
	}
	
	@RequestMapping("/frame/topic_right.do")
	public String topicRight(ModelMap model){
		return "frame/topic_right";
	}
